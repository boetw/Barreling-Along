...
(function() {
	var a = this,
		b = b || {};
	b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v1.5.0",
		b.blendModes = {
			NORMAL: 0,
			ADD: 1,
			MULTIPLY: 2,
		...
		b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180,
		...
		b.Matrix.prototype.toArray = function(a) {
			...
			var b = this.array;
			return a ? (this.array[0] = this.a, this.array[1] = this.c, this.array[2] = 0, this.array[3] = this.b, this.array[4] = this.d, this.array[5] = 0, this.array[6] = this.tx, this.array[7] = this.ty, this.array[8] = 1) : (this.array[0] = this.a,
				this.array[1] = this.b, this.array[2] = this.tx, this.array[3] = this.c, this.array[4] = this.d, this.array[5] = this.ty, this.array[6] = 0, this.array[7] = 0, this.array[8] = 1), b
		...
		b.DisplayObject.prototype._generateCachedSprite = function() {
			...
			var d = this._filters;
			this._filters = null, this._cachedSprite.filters = d,
				this._cachedSprite.texture.render(this), this._filters = d, this._cacheAsBitmap = !0
		},
